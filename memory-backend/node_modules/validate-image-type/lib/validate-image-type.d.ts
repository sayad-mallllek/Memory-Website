 ...
 */
export declare function validateBufferMIMEType(buffer: Buffer, options: ValidateImageTypeOptions): ValidateImageResult;
/**
 ...
 * ```
 */
export declare function validateMIMEType(filePath: string, options: ValidateImageTypeOptions): ValidateImageResult;
